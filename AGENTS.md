...
- `docs/implementation-notes.md` — living status: what's built and what's next. Update it as you go.

Each doc has a Spanish mirror `*.es.md`; keep the pair in sync when you edit one.
